...
locations = [{country_name: "China", city_name: "Beijing", continent: "Asia", location_id: 1},
            {country_name: "Brazil", city_name: "Yucatán", continent: "South America", location_id: 2},
            {country_name: "Jordan", city_name: "Petra", continent: "Asia", location_id: 3},
            {country_name: "Peru", city_name: "Cusco", continent: "South America", location_id: 4},
            {country_name: "Brazil", city_name: "Rio de Janeiro", continent: "South America", location_id: 5},
            {country_name: "Italy", city_name: "Rome", continent: "Europe", location_id: 6},
            {country_name: "India", city_name: "Agra", continent: "Asia", location_id: 7}]
    ...
    wonders = [ {title: "Great Wall of China", year_discovered: "1474", description: "Great might be an understatement. One of the world’s largest building-construction projects, 
                ...
                Instead, scholars have noted that it served more as “political propaganda.”", wonder_id: 1},
                {title: "Chichén Itzá", year_discovered: "550", description: "Chichén Itzá is a Mayan city on the Yucatán Peninsula in Mexico, which flourished in the 9th and 10th centuries CE. 
                ...
                On that field the residents played a ritual ball game popular throughout pre-Columbian Mesoamerica.", wonder_id: 2},
                {title: "Petra", year_discovered: "1812", description: "The ancient city of Petra, Jordan, is located in a remote valley, nestled among sandstone mountains and cliffs. 
                ...
                Although rediscovered in 1912, it was largely ignored by archaeologists until the late 20th century, and many questions remain about the city.", wonder_id: 3},
                {title: "Machu Picchu", year_discovered: "1911", description: "This Incan site near Cuzco, Peru, was “discovered” in 1911 by Hiram Bingham, who believed it was Vilcabamba, 
                ...
                Despite its relative isolation high in the Andes Mountains, it features agricultural terraces, plazas, residential areas, and temples.", wonder_id: 4},
                {title: "Christ the Redeemer", year_discovered: "1931", description: "Christ the Redeemer, a colossal statue of Jesus, stands atop Mount Corcovado in Rio de Janeiro. Its origins date to just after World War I, 
                ...
                and in 2014 the tip of Jesus’s right thumb was damaged during a storm.", wonder_id: 5},
                {title: "Colosseum", year_discovered: "80", description: "The Colosseum in Rome was built in the first century by order of the Emperor Vespasian. A feat of engineering, the amphitheater measures 620 by 513 feet 
                ...
                Additionally, so many animals were captured and then killed there that certain species reportedly became extinct.", wonder_id: 6},
                {title: "Taj Mahal", year_discovered: "1653", description: "This mausoleum complex in Agra, India, is regarded as one of the world’s most iconic monuments and is perhaps the finest example of Mughal architecture. 
                ...
                According to some reports, Shah Jahān wished to have his own mausoleum made out of black marble. However, he was deposed by one of his sons before any work began.", wonder_id: 7}]
...
#rails g migration create_wonder title:string year_discovered:integer description:string wonder_id:integer --timestamps --no-test-framework
#rails g migration create_location country_name:string city_name:string continent:string location_id:integer --timestamps --no-test-framework